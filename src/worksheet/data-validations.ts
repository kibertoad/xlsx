...
export function makeDataValidation(
  ...
  return {
    ...
    ...(opts.formula1 !== undefined ? { formula1: normalizeFormulaText(opts.formula1, 'makeDataValidation formula1') } : {}),
    ...(opts.formula2 !== undefined ? { formula2: normalizeFormulaText(opts.formula2, 'makeDataValidation formula2') } : {}),
